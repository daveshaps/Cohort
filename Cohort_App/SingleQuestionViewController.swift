...
//        super.viewDidLoad()
//        
//        responderFirstName = appDelegate.currentPerson!.firstName
//        
//        askerNameTextField = questionAskerName as UITextField
//        
...
//        
//        let answerDict = [answerText: answerText, responderFirstName: self.responderFirstName, userID: self.userID]
//        
